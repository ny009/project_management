          ...
          <CCardBody>
            <CTabs>
              <CTab title="Phase1" active>
                <br>
                <p>
                <strong>Task1 </strong>task detail<br><CButton size="sm" color="primary">finish</CButton><br><hr>
                <strong>Task2 </strong>task detail<br><CButton size="sm" color="primary">finish</CButton><br><hr>
                <strong>Task3 </strong>task detail<br><CButton size="sm" color="primary">finish</CButton><br><hr>
                </p>
              </CTab>
...
<CForm>
      ...
      <CCol md="3">
        <CCard>
          <CCardHeader>
            <CIcon name="cil-justify-center"/><strong> Recent Due </strong>
          </CCardHeader>
          <CCardBody>
            <CListGroup>
              <CListGroupItem
              ...
              >
                ...
                <small>18 days from now</small><br>
                <small>Post by: Morty Al-Banna</small><br>
                <small>Type: team</small><br>
