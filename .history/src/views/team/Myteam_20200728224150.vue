          ...
          <CCardBody>
            <CTabs>
              <CTab title="Phase1" active>
                <br>
                <p>
                <strong>Task1 </strong>task detail<CButton color="primary">finish</CButton><br>
                <strong>Task2 </strong>task detail<CButton color="primary">finish</CButton><br>
                <strong>Task3 </strong>task detail<CButton color="primary">finish</CButton><br>
                </p>
              </CTab>
