          ...
          <CCardBody>
            <CTabs>
              <CTab title="Phase1" active>
                <br>
                <p>
                <strong>Task1 </strong>task detail<CButton color="primary">finish</CButton><br><hr>
                <strong>Task2 </strong>task detail<CButton color="primary">finish</CButton><br><hr>
                <strong>Task3 </strong>task detail<CButton color="primary">finish</CButton><br><hr>
                </p>
              </CTab>
