...
<template>
  <CRow>
    <CCol col="12" md="6">
        ...
        <CCardBody>
          <CForm>
            <CInput placeholder="Title" label="Title"/>
            <CInput placeholder="Detail" label="Detail"/>
            <CInput placeholder="Term" label="Term"/>
            <CInput placeholder="Course" label="Course"/>
            <CInput type="date"  label="Start_time"/>
            <CInput type="date"  label="End_time"/>
          </CForm>
        </CCardBody>
      </CCard>
