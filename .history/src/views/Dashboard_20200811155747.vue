        ...
        <CCard>
          ...
          <CCardBody>
           ...
           <CDataTable
              ...
              no-sorting
            >
              <td slot="process" slot-scope="process">
                <div class="clearfix">
                  <div class="float-left">
                    <strong>({{team_info.finished_phase_num}}/{{team_info.all_phase_num}})*100)%</strong>
                  </div>
                ...
                <CProgress
                  class="progress-xs"
                  :value="(team_info.finished_phase_num/team_info.all_phase_num)*100+100"
